...
class GameBoard:
    ...
    def check_horizontal(self, i):
        ...
        for a in [i, i + 1, i + 2, i + 3, i + 4]:
            if self.board[a] != value or self.get_coordinates(a)[1] != y:
                return False
        return True
    ...
    def check_vertical(self, i):
        ...
        for a in [i, i + w, i + w * 2, i + w * 3, i + w * 4]:
            if self.board[a] != value or self.get_coordinates(a)[0] != x:
                return False
        return True
    ...
    def check_diagonal1(self, i):
        ...
        for a in range(len(checks)):
            ...
            if self.board[checks[a]] != value or self.get_coordinates(checks[a]) != (x+a, y+a):
                return False
        return True
